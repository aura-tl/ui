...
```bash
npx --yes --package=github:aura-tl/ui#v0.3.1 -- aura-ui create scores-app --cwd aura-scores
```
...
```bash
npx --yes --package=github:aura-tl/ui#v0.3.1 -- aura-ui inspect mobile-score-center
npx --yes --package=github:aura-tl/ui#v0.3.1 -- aura-ui add mobile-score-center
```
