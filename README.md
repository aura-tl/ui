...
```bash
npx --yes --package=github:aura-tl/ui#v0.1.0 -- aura-ui create scores-app --cwd aura-scores
```
...
bytes remain attributed to that Aura account.

Inspect or add an editable component to an existing Next app:

```bash
npx --yes --package=github:aura-tl/ui#v0.1.0 -- aura-ui inspect mobile-score-center
npx --yes --package=github:aura-tl/ui#v0.1.0 -- aura-ui add mobile-score-center
```
