...
// Source: prod ezbase `market_snapshots` (fused consensus) projected through GET /api/games/{gameId}/odds/timeline?marketType=spread.
// Game: d28a234140589eb6c3c9b5ab — MIL @ LAD, in progress, 2026-08-13. Last eight retained consensus points.
...
import { toAuraOddsStripModel, type AuraOddsStripState } from '@/lib/aura/odds-strip-types';
...
export const auraOddsStripFixture: AuraOddsStripState = {
  status: 'ready',
  error: null,
  model: toAuraOddsStripModel(game, timeline),
};
