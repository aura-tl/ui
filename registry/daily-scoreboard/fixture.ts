...
// Games: tonight's real MLB slate — four finals and two in progress at capture time.
// Never fabricate fixture data — recapture from a real board instead.
import { toAuraDailyScoreboardModel, type AuraDailyScoreboardState } from '@/lib/aura/daily-scoreboard-types';
...
export const auraDailyScoreboardFixture: AuraDailyScoreboardState = {
  status: 'ready',
  error: null,
  model: toAuraDailyScoreboardModel('2026-08-13', 'MLB', games),
};
