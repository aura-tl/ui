...
// Source: prod ezbase `market_snapshots` (canonical consensus) projected through GET /api/games/{gameId}/odds/timeline?marketType=spread.
...
export const auraLineMovementFixture: AuraLineMovementState = {
  status: 'ready',
  error: null,
  model: toAuraLineMovementModel(timeline, game),
};
